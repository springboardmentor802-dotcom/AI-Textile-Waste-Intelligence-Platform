...
import {
  ...
  FiFileText, FiTruck, FiUser, FiLock, FiChevronRight,
  FiSearch, FiPieChart,
} from "react-icons/fi";
...
const NAV = {
  "admin": [
    ...
    { label: "Inventory Analytics", icon: FiPieChart, path: "/admin/inventory-analytics" },
  ...
  "recycling_operator": [
    ...
    { label: "Inventory Analytics", icon: FiPieChart, path: "/operator/inventory-analytics" },
  ...
  "sustainability_manager": [
    ...
    { label: "Inventory Analytics", icon: FiPieChart, path: "/sustainability/inventory-analytics" },
  ...
  "textile_manufacturer": [
    ...
    { label: "Inventory Analytics", icon: FiPieChart, path: "/manufacturer/inventory-analytics" },
...
const S = {
  sidebar: { backgroundColor: "#0f172a", minHeight: "100vh", display: "flex", flexDirection: "column", transition: "width 0.2s ease", flexShrink: 0, overflow: "hidden" },
  brand: { display: "flex", alignItems: "center", gap: 10, padding: "18px 14px", borderBottom: "1px solid #1e293b" },
  brandMark: { width: 30, height: 30, borderRadius: 6, display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 11, fontWeight: 800, flexShrink: 0 },
  brandName: { fontSize: 13, fontWeight: 700, color: "#f1f5f9" },
  brandSub: { fontSize: 10, color: "#64748b" },
  userCard: { display: "flex", alignItems: "center", gap: 10, padding: "12px 14px", borderBottom: "1px solid #1e293b" },
  avatar: { width: 32, height: 32, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 13, fontWeight: 700, flexShrink: 0 },
  ...
  navItem: { display: "flex", alignItems: "center", gap: 10, padding: "9px 10px", borderRadius: 6, border: "none", fontSize: 13, fontWeight: 500, cursor: "pointer", textAlign: "left", width: "100%", transition: "background 0.15s", whiteSpace: "nowrap" },
  navLabel: { flex: 1 },
  logoutBtn: { display: "flex", alignItems: "center", gap: 10, margin: "8px", padding: "9px 10px", border: "none", borderRadius: 6, backgroundColor: "#1e293b", color: "#f87171", fontSize: 13, fontWeight: 500, cursor: "pointer", whiteSpace: "nowrap" },
};