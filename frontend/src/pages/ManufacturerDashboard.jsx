...
const CARDS = [
  { icon:"👕", label:"Uploaded Textile Products", value:"—", color:"#d97706" },
  { icon:"🧵", label:"Fabric Types", value:"—", color:"#059669" },
  { icon:"🔍", label:"Pending Analysis", value:"—", color:"#0891b2" },
  { icon:"♻", label:"Recycling Suggestions", value:"—", color:"#7c3aed" },
];
...
export default function ManufacturerDashboard() {
  ...
  return (
    <div style={S.layout}>
      <Sidebar />
      <div style={S.main}>
        <Navbar title="Textile Manufacturer Dashboard" />
        <div style={S.content}>
          <div style={S.welcome}>
            <h2 style={S.welcomeTitle}>Welcome back, {user?.full_name}! 👋</h2>
            <p style={S.welcomeText}>
              Manage your textile products and recycling suggestions. Data populates after integration.
            </p>
          </div>
          ...
          <div style={S.row}>
            <div style={{ ...S.panel, flex:1 }}>
              <h3 style={S.panelTitle}>Recent Products</h3>
              <div style={S.placeholder}>
                <span style={S.phIcon}>👕</span>
                <p>Products will appear here after dataset integration.</p>
              </div>
            </div>
            <div style={{ ...S.panel, flex:1 }}>
              <h3 style={S.panelTitle}>Recycling Suggestions</h3>
              <div style={S.placeholder}>
                <span style={S.phIcon}>♻</span>
                <p>Suggestions will appear here after dataset integration.</p>
              </div>
            </div>
          </div>
          ...
          <div style={S.infoCard}>
            ...
            <div style={S.infoRow}>
              ...
              <span style={{ ...S.infoValue, ...S.roleBadge, backgroundColor:"#d97706" }}>
                {user?.role}
              </span>
            </div>
            <div style={S.infoRow}>
...
const S = {
  layout: { display:"flex", minHeight:"100vh", backgroundColor:"#fffbeb", fontFamily:"'Segoe UI',sans-serif" },
  ...
  panel: { backgroundColor:"#fff", borderRadius:14, padding:"24px 28px", boxShadow:"0 2px 12px rgba(0,0,0,0.04)", minWidth:280 },
