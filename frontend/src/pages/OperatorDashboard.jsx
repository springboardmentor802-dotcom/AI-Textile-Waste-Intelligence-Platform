...
const CARDS = [
  { icon:"♻", label:"Assigned Waste Items", value:"—", color:"#059669" },
  { icon:"📋", label:"Recycling Requests", value:"—", color:"#0891b2" },
  { icon:"✅", label:"Completed Jobs", value:"—", color:"#7c3aed" },
  { icon:"⏳", label:"Pending Jobs", value:"—", color:"#d97706" },
];
...
export default function OperatorDashboard() {
  ...
  return (
    <div style={S.layout}>
      <Sidebar />
      <div style={S.main}>
        <Navbar title="Recycling Facility Dashboard" />
        <div style={S.content}>
          <div style={S.welcome}>
            <h2 style={S.welcomeTitle}>Welcome back, {user?.full_name}! 👋</h2>
            <p style={S.welcomeText}>
              Manage your recycling operations. Data will populate after integration.
            </p>
          </div>
          ...
          <div style={S.row}>
            <div style={{ ...S.panel, flex:1 }}>
              <h3 style={S.panelTitle}>Recent Waste Items</h3>
              <div style={S.placeholder}>
                <span style={S.phIcon}>♻</span>
                <p>Waste items will appear here after dataset integration.</p>
              </div>
            </div>
            <div style={{ ...S.panel, flex:1 }}>
              <h3 style={S.panelTitle}>Pending Requests</h3>
              <div style={S.placeholder}>
                <span style={S.phIcon}>📋</span>
                <p>Requests will appear here after dataset integration.</p>
              </div>
            </div>
          </div>
          ...
          <div style={S.infoCard}>
            ...
            <div style={S.infoRow}>
              ...
              <span style={{ ...S.infoValue, ...S.roleBadge, backgroundColor:"#059669" }}>
                {user?.role}
              </span>
            </div>
            <div style={S.infoRow}>
...
const S = {
  layout: { display:"flex", minHeight:"100vh", backgroundColor:"#f0fdf4", fontFamily:"'Segoe UI',sans-serif" },
